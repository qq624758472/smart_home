...
/* HCI interface */
#define	ZBHCI_UART						1   //使用uart需要将该值置1,只有GW需要和cpu通信
...
#endif
	#define BOARD						BOARD_8258_DONGLE//BOARD_8258_EVK_V1P2 //BOARD_8258_DONGLE //BOARD_8258_EVK_V1P2 //BOARD_8258_EVK
