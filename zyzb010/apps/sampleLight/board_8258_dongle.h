...
// KEY
#define	BUTTON1 					GPIO_PD4//GPIO_PD7
...
//lsh add 
#define	BUTTON1 					GPIO_PD3  //自研模组的按键
...
#define LED_R						GPIO_PC4	//D1 -- red			PWM2_N
#define LED_G						GPIO_PB4	//D2 -- green		PWM0_N
#define LED_B						GPIO_PB5	//D3 -- blue		PWM1_N
...
//PWM configuration, LED_Y as warm light, LED_W a cool light.
#define LED_Y						GPIO_PC3	//D3 -- yellow		PWM2
#define LED_W						GPIO_PC2	//D5 -- white		PWM4

#define PWM_Y_CHANNEL				1//PWM2
#define PWM_Y_CHANNEL_SET()			do{	\
										gpio_set_func(LED_Y, AS_PWM1); 		\
									}while(0)

#define PWM_W_CHANNEL				3//PWM4
...
#define LED_B	                    GPIO_PB5	//D3 -- blue		PWM1_N
#define LED_W						GPIO_PC2	//D4 -- yellow		PWM3

#define PWM_B_CHANNEL				5//PWM1_N
#define PWM_B_CHANNEL_SET()			do{	\
										gpio_set_func(LED_B, AS_PWM5_N); 	\
										drv_pwm_n_invert(PWM_B_CHANNEL); 	\
									}while(0)
...
// #define PWM_G_CHANNEL				4//PWM0_N
// #define PWM_G_CHANNEL_SET()			do{	\
// 										gpio_set_func(LED_G, AS_PWM4_N); 	\
// 										drv_pwm_n_invert(PWM_G_CHANNEL); 	\
// 									}while(0)
// #define R_LIGHT_PWM_CHANNEL			PWM_R_CHANNEL
// #define G_LIGHT_PWM_CHANNEL			PWM_G_CHANNEL                
...
// DEBUG
#if UART_PRINTF_MODE
	#define	DEBUG_INFO_TX_PIN	    GPIO_PD7 //GPIO_PB1//GPIO_PD7//GPIO_PC4//print
#endif
/*******************************************************************************************************
...
/*******************************************************************************************************
*********************8258Dongle with 48 Pins: Start*  lsh 执行的这个****************************************************
*******************************************************************************************************/
//KEY
...
#define PWM_Y_CHANNEL_SET()			do{	\
										gpio_set_func(LED_Y, AS_PWM2_N); 		\
									}while(0)

#define PWM_W_CHANNEL				4//PWM4
#define PWM_W_CHANNEL_SET()			do{	\
										gpio_set_func(LED_W, AS_PWM4_N);		\
									}while(0)
