...
void user_app_init(void)
{
    ...
    /* Register ZCL specific cluster information ע��ZCL�ض��ļ�Ⱥ��Ϣ*/
    zcl_register(SAMPLE_LIGHT_ENDPOINT, SAMPLELIGHT_CB_CLUSTER_NUM, (zcl_specClusterInfo_t *)g_sampleLightClusterList); // g_sampleLightClusterList:������п�����ɫ�����ȵġ�
...
void user_init(bool isRetention)
{
    (void)isRetention;
    //     pwm_yw_test();
    // printf("init success start MCU\r\n");

    /* Initialize LEDs*/
    led_init();
    hwLight_init(); // led��ռ�ձ� ���ó����Ҳ�����������ڵ�tick�����ڸߵ�ƽ
    ...
    /* Register except handler for test ע�����������֮��Ĳ���*/
