...
void sampleLight_colorInit(void)
{
    ...
    printf("[%s:%d] sampleLight_colorInit start\r\n", __FUNCTION__, __LINE__);

#if COLOR_RGB_SUPPORT
    pColor->colorCapabilities = ZCL_COLOR_CAPABILITIES_BIT_HUE_SATURATION; // 色调饱和度
    ...
    printf("[%s:%d] sampleLight_colorInit end\r\n", __FUNCTION__, __LINE__);
}
...
#if COLOR_RGB_SUPPORT
    // hwLight_colorUpdate_HSV2RGB����������ǰ��ɫ�ࣨhue�������Ͷȣ�saturation�������ȣ�level��ת��ΪRGB��ɫ   Hue：色调
    LOG("pColor->currentHue=%d,pColor->currentSaturation=%d,pLevel->curLevel=%d\r\n", pColor->currentHue, pColor->currentSaturation, pLevel->curLevel);
 ...
 *
 * @brief   Handler for ZCL COLOR CONTROL command. This function will set Color Control attribute first.ZCL COLOR CONTROL����Ĵ������򡣴˺������������á���ɫ���ơ����ԡ�
 *
 * @param   pAddrInfo
 * @param   cmdId - color cluster command id ��ɫ������ ID
 * @param   cmdPayload
 *
 * @return  status_t
 */
