 ...
 ****************************************************************/
#if defined COLOR_RGB_SUPPORT && (COLOR_RGB_SUPPORT == 1) // 当且仅当 COLOR_RGB_SUPPORT 宏被定义且其值为 1 时，条件表达式才为真。
...
/*******************************************************************************************************
*********************8258Dongle with 48 Pins: Start   lsh执行的这块代码**********************************
*******************************************************************************************************/
// KEY
...
#define Y_LIGHT_PWM_CHANNEL PWM_Y_CHANNEL
#define W_LIGHT_PWM_CHANNEL PWM_W_CHANNEL
#define Y_LIGHT_PWM_SET() PWM_Y_CHANNEL_SET()
#define W_LIGHT_PWM_SET() PWM_W_CHANNEL_SET()
#endif
#else
