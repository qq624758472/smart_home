...
void sampleLight_levelInit(void)
{
    ...
    printf("[%s:%d] levelInfo.stepLevel256=%d,levelInfo.currentLevel256=%d,levelInfo.withOnOff=%d\r\n", __FUNCTION__, __LINE__, levelInfo.currentLevel256, levelInfo.currentLevel256, levelInfo.withOnOff);
